...
import { getUserDetails, userUpdated } from '../../../store/reducers/user/userDetailsSlice';
import { updateUser, updateUserReset } from '../../../store/reducers/user/userSlice';
...
const EditOwnerPage = () => {
    ...
    const { loading, isUpdated } = useAppSelector((state) => state.user);
