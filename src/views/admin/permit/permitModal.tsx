...
import { updatePermit } from '../../../store/reducers/permit/permitSlice';
...
const PermitModal: React.FC<PermitModalProps> = ({ isOpen, onClose, id }) => {
                    ...
                    <div className="flex items-center justify-center min-h-screen">
                        ...
                        <div className="z-50 bg-white p-2 rounded-lg shadow-md lg:w-2/5 w-4/5">
                            <div className="flex items-center justify-between">
                                <h2 className="text-2xl font-semibold ml-2 text-indigo-500">Update Store Permit</h2>
