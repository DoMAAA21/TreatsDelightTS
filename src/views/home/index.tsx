    ...
    return (
        <>
            ...
            <div className="overflow-x-hidden">
                            ...
                            <div className="lg:flex items-center">
                                ...
                                <div className="text-white mr-8 " data-aos="fade-right" data-aos-delay={500}>
                                    ...
                                    <div className="flex mt-6" data-aos="fade-up" data-aos-delay={500}>
                                        <button onClick={() => navigate('/shop')} className="bg-green-700 hover:bg-green-900 text-white font-bold  py-4 px-8  lg:px-12 mr-4 rounded-3xl">
                                            Shop Now
                                        </button>
                                        <button onClick={handleScrollDown} className="bg-transparent  hover:bg-green-500 text-white border border-white font-bold py-4 px-8 lg:px-12 rounded-3xl">
                                            Know More
                                        </button>
                                    </div>
                                </div>
                ...
                <div ref={targetRef} className="flex flex-col items-center max-w-full mt-10 p-4" id="aboutme">
