...
import { fetchDoctorAllItems } from '../../../store/reducers/product/allProductsSlice';
        ...
        rows: products.map((product) => ({
            ...
            actions: (
                <div className="flex items-center ml-6">
                    <Link to={`/doctor/product/${product._id}`} className="mr-2 w-8 h-8 md:h-14 md:w-12 lg:h-8 lg:w-8">
                        <img
                            src={EditIcon}
                            alt="Edit Icon"
...
export default DoctorProductPage;
